...
class TestKeyScheduler(unittest.TestCase):
    ...
    def test_round_keys_length(self):
        ...
        ks = KeyScheduler(base_key=b"testkey", num_rounds=10, round_key_size=64)
    ...
    def test_get_specific_round_key(self):
        ...
        ks = KeyScheduler(base_key=b"secure", num_rounds=5, round_key_size=64)
    ...
    def test_round_key_size(self):
        ...
        ks = KeyScheduler(base_key=b"sizecheck", num_rounds=3, round_key_size=32)
        for key in ks.round_keys:
            self.assertLess(key, 2**32)

    def test_invalid_round_index(self):
        ks = KeyScheduler(base_key=b"invalid", num_rounds=4, round_key_size=64)
    ...
    def test_different_keys_for_different_rounds(self):
        ...
        ks = KeyScheduler(base_key=b"diffrounds", num_rounds=4, round_key_size=64)
        keys = ks.round_keys
    ...
    def test_same_input_same_keys(self):
        ...
        ks1 = KeyScheduler(base_key=b"repeatable", num_rounds=5, round_key_size=64)
        ks2 = KeyScheduler(base_key=b"repeatable", num_rounds=5, round_key_size=64)
